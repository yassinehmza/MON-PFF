...
function AdministrateurLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        await authService.loginAdministrateur(email, password);
      ...
      <main className="pt-24 flex items-center justify-center p-4 min-h-screen">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900">Espace Administration</h2>
