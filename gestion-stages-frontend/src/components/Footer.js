        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              <img src={logoOFPPT} alt="OFPPT Logo" className="h-10 w-auto" />
              <div>
                <h3 className="text-lg font-bold text-white">OFPPT</h3>
                <p className="text-sm text-gray-400">Formation Professionnelle</p>
              </div>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/apropos" className="text-gray-400 hover:text-white transition-colors">
                  À propos
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center space-x-2">
                ...
                <span>123 Rue de la Formation, Casablanca</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
